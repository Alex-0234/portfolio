...
export const PORTFOLIO: PortfolioPiece[] = [
    ...
    { number: 4, name: 'portfolio', type: 'personal', startYear: 2026, startMonth: 8, description: 'Toto je můj aktuální portfólio web. Je to vícestránkový portfólio pro škálovatelnost a zvýšenou viditelnost ve vyhledávači Google.', links: {} },
    { number: 5, name: 'eshop-koncept', type: 'freelance', startYear: 2026, startMonth: 8, description: 'Koncept poměrně malého eshopu. Aktuálně na něm pracuju. Zatim jsem strávil 1 hodinu stavbou a to spíše na věcech v pozadí.', links: {web: 'https://eshop-concept.alexliska.workers.dev/', github: 'https://github.com/Alex-0234/eshop-concept'} },
