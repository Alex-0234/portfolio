...
export default function Hero() {
    ...
    useGSAP(() => {
        ...
        const viewport = () => stageRef.current?.offsetHeight ?? window.innerHeight
    ...
    return (
        <div ref={heroRef} className='relative h-lvh w-full bg-dark'>
            ...
            <div
                ref={stageRef}
                className='absolute inset-x-0 top-0 flex h-svh flex-col items-center justify-end uppercase leading-none'
            >
